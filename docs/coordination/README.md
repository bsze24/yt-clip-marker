...
Not a coordination doc, but the one most often wanted alongside them:
`docs/reference/EVAL.md` — eval state, the corpus, and the roadmap beyond hand-edited rules.
