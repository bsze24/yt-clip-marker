...
Studio is the active surface; the extension is frozen at coarse capture. Two-surface
code is on GitHub as open **PR 3** (product), **PR 4** (video 1 store), **PR 5**
(session log) — not yet merged to `main`. Live baton: `docs/coordination/CURRENT.md`.
Change history: `docs/prs/`.
